            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('roles.store') }}">
                    ...
                    <div class="form-group{{ ($errors->has('fullname')) ? $errors->first('name') : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="fullname" type="text" name="fullname" class="form-control" placeholder="Enter fullname here" required>
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control" name="name" placeholder="Enter name here" required>
